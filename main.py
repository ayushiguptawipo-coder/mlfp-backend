...
# =====================================================================
# FULL SCHEMA US PEERS: Complete keys to prevent frontend property errors
# =====================================================================
US_PEERS = {
    "AAPL": {
        "sector_profile": "US_TECH", "market_cap_cr": 28000.5,
        "dupont": {"roe": 151.9, "profit_margin": 26.92, "asset_turnover": 1.16, "financial_leverage": 4.87, "verdict": "Pricing Power"},
        "altman_z": {"score": 8.5, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 97.95, "nopat_cr": 112.28, "wacc_pct": 10.5, "invested_capital_cr": 136.4, "status": "Value Creator", "verdict": "Generates true economic profit of $97.95 B"},
        "forensics": {
            "piotroski_f": {"score": 6, "status": "Moderate Health", "badge": "yellow", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.25, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    },
    "MSFT": {
        "sector_profile": "US_TECH", "market_cap_cr": 31000.2,
        "dupont": {"roe": 38.5, "profit_margin": 35.12, "asset_turnover": 0.72, "financial_leverage": 1.52, "verdict": "High Margin Software"},
        "altman_z": {"score": 9.2, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 84.50, "nopat_cr": 95.10, "wacc_pct": 10.0, "invested_capital_cr": 106.0, "status": "Value Creator", "verdict": "Generates true economic profit of $84.50 B"},
        "forensics": {
            "piotroski_f": {"score": 8, "status": "Strong Health", "badge": "green", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.60, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    },
    "GOOGL": {
        "sector_profile": "US_TECH", "market_cap_cr": 21500.0,
        "dupont": {"roe": 28.4, "profit_margin": 25.80, "asset_turnover": 0.78, "financial_leverage": 1.41, "verdict": "Monopoly Advantage"},
        "altman_z": {"score": 11.4, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 68.20, "nopat_cr": 78.40, "wacc_pct": 9.8, "invested_capital_cr": 104.0, "status": "Value Creator", "verdict": "Generates true economic profit of $68.20 B"},
        "forensics": {
            "piotroski_f": {"score": 7, "status": "Strong Health", "badge": "green", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.40, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    },
    "AMZN": {
        "sector_profile": "US_TECH", "market_cap_cr": 19000.8,
        "dupont": {"roe": 22.1, "profit_margin": 6.80, "asset_turnover": 1.15, "financial_leverage": 2.82, "verdict": "Asset Velocity"},
        "altman_z": {"score": 6.8, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 32.40, "nopat_cr": 44.80, "wacc_pct": 10.2, "invested_capital_cr": 121.0, "status": "Value Creator", "verdict": "Generates true economic profit of $32.40 B"},
        "forensics": {
            "piotroski_f": {"score": 6, "status": "Moderate Health", "badge": "yellow", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.15, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    },
    "META": {
        "sector_profile": "US_TECH", "market_cap_cr": 12500.4,
        "dupont": {"roe": 31.8, "profit_margin": 32.40, "asset_turnover": 0.68, "financial_leverage": 1.44, "verdict": "Pricing Power"},
        "altman_z": {"score": 13.1, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 42.10, "nopat_cr": 49.50, "wacc_pct": 10.0, "invested_capital_cr": 74.0, "status": "Value Creator", "verdict": "Generates true economic profit of $42.10 B"},
        "forensics": {
            "piotroski_f": {"score": 8, "status": "Strong Health", "badge": "green", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.75, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    },
    "NVDA": {
        "sector_profile": "US_TECH", "market_cap_cr": 29000.1,
        "dupont": {"roe": 115.3, "profit_margin": 55.20, "asset_turnover": 1.25, "financial_leverage": 1.67, "verdict": "Hyper Pricing Power"},
        "altman_z": {"score": 15.2, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 65.80, "nopat_cr": 72.10, "wacc_pct": 11.0, "invested_capital_cr": 57.0, "status": "Value Creator", "verdict": "Generates true economic profit of $65.80 B"},
        "forensics": {
            "piotroski_f": {"score": 9, "status": "Strong Health", "badge": "green", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.30, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    },
    "TSLA": {
        "sector_profile": "US_TECH", "market_cap_cr": 6800.5,
        "dupont": {"roe": 25.2, "profit_margin": 14.50, "asset_turnover": 1.05, "financial_leverage": 1.65, "verdict": "Asset Velocity"},
        "altman_z": {"score": 5.4, "zone": "Safe Zone", "badge": "green", "desc": "Derived from verified balance sheet filings."},
        "eva": {"eva_cr": 12.80, "nopat_cr": 18.20, "wacc_pct": 11.2, "invested_capital_cr": 48.0, "status": "Value Creator", "verdict": "Generates true economic profit of $12.80 B"},
        "forensics": {
            "piotroski_f": {"score": 6, "status": "Moderate Health", "badge": "yellow", "desc": "Audited proxy comparison."},
            "beneish_m": {"score": -2.10, "verdict": "Unlikely Manipulator", "badge": "green", "desc": "Multi-variable forensic accrual audit."}
        }
    }
}
...
def calculate_live_fundamentals(ticker_symbol, is_us=False):
    try:
        ...
        # Enforce clean classification
        if is_us:
            sector = "US_TECH"
        elif any(k in sector_str or k in ind_str for k in ["BANK", "FINANCIAL", "INSURANCE"]):
            sector = "BFSI"
        elif any(k in sector_str or k in ind_str for k in ["TECH", "SOFTWARE", "IT", "HEALTHCARE", "COMMUNICATION"]):
            sector = "SERVICE_TECH"
        else:
            sector = "MANUFACTURING_CAPITAL"
        ...
        if sector == "BFSI":
            ...
            if tot_assets > 0:
                ...
                x5 = rev / tot_assets
                if sector in ["SERVICE_TECH", "US_TECH"]:
                ...
                altman = {"score": score, "zone": zone, "badge": badge, "desc": "Derived from verified balance sheet filings."}
            else:
        ...
        if rev > 0 and assets > 0 and equity > 0:
            ...
            verdict = "Regulatory Float" if sector == "BFSI" else ("Pricing Power" if sector in ["SERVICE_TECH", "US_TECH"] else "Asset Velocity")
        ...
        wacc = 11.5 if sector == "BFSI" else (10.5 if sector in ["SERVICE_TECH", "US_TECH"] else 9.5)
        if sector == "BFSI":
...
def get_portfolio_basket(anchor_ticker: str = Query(None)):
    ...
    if anchor_ticker:
        ...
        fmt_anchor = clean_anchor if (clean_anchor in US_PEERS or len(clean_anchor) <= 4 and "." not in anchor_ticker) else f"{clean_anchor}.NS"
        if fmt_anchor not in candidate_universe:
            candidate_universe.insert(0, fmt_anchor)
...
def analyze_stock(ticker: str, instrument_key: str = Query(None), friction: float = Query(0.0015), neutral_band: float = Query(0.05)):
    ...
    # STRICT US AUTO-DETECTION: Prevents foreign stocks from executing under Indian regime
    is_us_stock = bool((instrument_key and instrument_key.startswith("US_EQ|")) or clean_sym in US_PEERS or clean_sym in GRANULAR_SECTORS.get("US_TECH", []))
    ...
    try:
        ...
        ai_score, ai_summary = 0.0, f"News parser: {str(e)}"
    ...
    if raw_fundamentals:
        ...
        if "eva" in fundamentals:
            unit_sym = "$" if is_us_stock else "₹"
            unit_name = "B" if is_us_stock else "Cr"
            if fundamentals["eva"].get("status") == "Value Creator":
                fundamentals["eva"]["verdict"] = f"Generates true economic profit of {unit_sym}{fundamentals['eva'].get('eva_cr', 0)} {unit_name}"
            else:
                fundamentals["eva"]["verdict"] = f"Destroys economic profit of {unit_sym}{fundamentals['eva'].get('eva_cr', 0)} {unit_name}"
        ...
        if live_fund:
            ...
            try:
                ...
                fundamentals = {
                    ...
                    "eva": {"eva_cr": 0.0, "nopat_cr": 0.0, "wacc_pct": 10.0, "invested_capital_cr": 0.0, "status": "Pending", "verdict": "Requires verified 10-K filings."},
                    "forensics": {
                ...
                fundamentals = {
                    ...
                    "eva": {"eva_cr": 0.0, "nopat_cr": 0.0, "wacc_pct": 10.0, "invested_capital_cr": 0.0, "status": "Pending", "verdict": "10-K required."},
    ...
    # =========================================================
    # STRICT SECTOR PEER MATCHER (Strictly isolates US vs Indian cohorts)
    # =========================================================
    peers_list = []
    matched_cohort = []
    ...
    # Fallback fill ONLY within the matching domestic/foreign universe
    if len(peers_list) < 5:
        for p_sym, p_data in INSTITUTIONAL_DB.items():
            if p_sym != clean_sym and p_sym not in [x["ticker"] for x in peers_list]:
                is_p_us = p_sym in US_PEERS or p_data.get("sector_profile") == "US_TECH"
                if is_us_stock and not is_p_us: continue # Never pollute US with Indian firms
                if not is_us_stock and is_p_us: continue # Never pollute Indian with US firms
                
                if p_data.get("sector_profile") == target_sector or target_sector in ["Global Large Cap", "US_TECH"]:
                    p_roe = p_data.get("dupont", {}).get("roe", "N/A")
                    if p_roe != "N/A":
                        try:
                            r_f = float(p_roe)
    ...
    response_payload = {
        ...
        "swing_4day_chart": swing_4day_chart,
